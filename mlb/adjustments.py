...
_VENUES: dict[str, list[tuple[int, int, float, float]]] = {
    "ARI": [(2010, 9999, 33.445, -112.067)],
    "ATL": [(2010, 2016, 33.735, -84.389), (2017, 9999, 33.890, -84.468)],
    "BAL": [(2010, 9999, 39.284, -76.622)],
    "BOS": [(2010, 9999, 42.346, -71.097)],
    "CHC": [(2010, 9999, 41.948, -87.655)],
    "CHW": [(2010, 9999, 41.830, -87.634)],
    "CIN": [(2010, 9999, 39.097, -84.507)],
    "CLE": [(2010, 9999, 41.496, -81.685)],
    "COL": [(2010, 9999, 39.756, -104.994)],
    "DET": [(2010, 9999, 42.339, -83.049)],
    "HOU": [(2010, 9999, 29.757, -95.356)],
    "KCR": [(2010, 9999, 39.051, -94.480)],
    "LAA": [(2010, 9999, 33.800, -117.883)],
    "LAD": [(2010, 9999, 34.074, -118.240)],
    "MIA": [(2010, 2011, 25.958, -80.239), (2012, 9999, 25.778, -80.220)],
    "MIL": [(2010, 9999, 43.028, -87.971)],
    "MIN": [(2010, 9999, 44.982, -93.278)],
    "NYM": [(2010, 9999, 40.757, -73.846)],
    "NYY": [(2010, 9999, 40.829, -73.926)],
    "ATH": [(2010, 2024, 37.751, -122.200), (2025, 9999, 38.580, -121.513)],
    "PHI": [(2010, 9999, 39.906, -75.166)],
    "PIT": [(2010, 9999, 40.447, -80.006)],
    "SDP": [(2010, 9999, 32.707, -117.157)],
    "SEA": [(2010, 9999, 47.591, -122.332)],
    "SFG": [(2010, 9999, 37.778, -122.389)],
    "STL": [(2010, 9999, 38.622, -90.193)],
    "TBR": [(2010, 2024, 27.768, -82.653), (2025, 9999, 27.980, -82.507)],
    "TEX": [(2010, 9999, 32.751, -97.083)],
    "TOR": [(2010, 9999, 43.641, -79.389)],
    "WSN": [(2010, 9999, 38.873, -77.008)],
}
