...
(`soccer/clubs/model/train.py`, `common/learners.py`; fitted artifact
`soccer/clubs/model/artifacts/outcome_model.pkl`, refit in-run daily).
Every input the model sees, 33 columns:
